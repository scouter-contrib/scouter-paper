    ...
    render() {
        return (
            <div className="step api-call2-step">
                ...
                <div className="message-content">{this.props.row.step.async === 1 ? '[async]' : ''}{this.props.row.mainValue} {Number(this.props.row.step.opt) === 1 ? '[addr] ' + this.props.row.step.address : ''}</div>
            </div>)
    }
}
