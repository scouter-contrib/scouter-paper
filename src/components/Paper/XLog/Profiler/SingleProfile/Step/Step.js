...
class Step extends Component {
    render() {
        ...
        return (
            <div className={"step-div " + (this.props.gap >= 5 ? ' has-gab ' : '') + (this.props.showGap ? ' show-gab ' : '')} style={{marginLeft : indent + "px"}} >
                {(this.props.showGap && this.props.gap >= 5) && <div className="gap-time">
                    <div>
